...
const manifestos = require('./manifestos');
const notasFiscais = require('./notasFiscais');
const notasItens = require('./notasItens');
...
module.exports = app => {
  ...
  app.use('/manifestos', manifestos)
  app.use('/notas-fiscais', notasFiscais)
  app.use('/notas-itens', notasItens)
  app.use('/paradas', paradas);
  app.use('/pedidos', pedidos);
  app.use('/pedidos-itens', pedidosItens)
